...
export default function Callout() {
  const isSaleOpen = false;
    const saleData = isSaleOpen ? saleOpen : saleClosed;
  return (
    <section className="section">
      <div className="section-wrapper">
        <h2 className="section-heading">{saleData.heading}</h2>
        <p className="section-description">{saleData.description}</p>
        {isSaleOpen ? (
            <a href={saleData.href} className="section-link">
