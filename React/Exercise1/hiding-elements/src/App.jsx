  ...
  return (
    <div className="review">
      <div className="review-wrapper">
        <img className="review-avatar" src ={review.avatarSrc}  />
        <div className="review-left">
          <h4 className="review-author"> {review.author}</h4>
          {review.rating >= 4 ? <ReviewRating review={review} /> : null}
          
        </div>
      </div>
      <div className="review-content">{review.rating >= 4 ? review.content : "No review"}</div>
    </div>
  );
}
